...
export default function BundleCreationForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("🔍 [Bundle Form] Submitting form data:", formData)
      ...
      console.log("📡 [Bundle Form] Response status:", response.status)

      const data = await response.json()
      console.log("📦 [Bundle Form] Response data:", data)
      ...
      console.error("❌ [Bundle Form] Network error:", err)
      setError({
        code: "NETWORK_ERROR",
  ...
  const handleInputChange = (field: keyof BundleFormData, value: string) => {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>Create a premium content bundle that customers can purchase</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter bundle title (max 100 characters)"
              maxLength={100}
          ...
          <Button type="submit" disabled={isCreating} className="w-full">
            {isCreating ? (
              <>
                ...
                Creating Bundle & Syncing with Stripe...
              </>
            ) : (
              "Create Bundle"
            )}
          ...
          <Alert>
            ...
            <AlertDescription>
              <div className="space-y-2">
                <div>
                  When you create a bundle, we'll automatically set up the corresponding product in your Stripe account.
                  Make sure your Stripe account is fully set up and can accept payments.
                </div>
