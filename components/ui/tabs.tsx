...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex h-10 items-center justify-center rounded-md bg-gray-900 p-1 text-white", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "text-white hover:border hover:border-red-600 hover:rounded-md",
      className,
    )}
    {...props}
  />
