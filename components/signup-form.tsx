            ...
            {!showEmailForm ? (
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full h-12 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg transition-all duration-200"
                ...
                <div className="space-y-2">
                  <div className="relative">
                    <Input
                      ...
                      className={cn(
                        "h-12 bg-gray-800 border-gray-600 text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500",
                        usernameAvailable === false ? "border-red-500" : usernameCheckFailed ? "border-yellow-500" : "",
                      )}
                      required
                    />
