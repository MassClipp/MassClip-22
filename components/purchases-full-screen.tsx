        ...
        <div className="w-full h-full overflow-y-auto">
          <div className="w-full px-6 py-8">
            ...
            <div className="space-y-0">
              {[...Array(5)].map((_, i) => (
                <div key={i} className="flex items-center gap-0 bg-zinc-900/30 border-b border-zinc-800/50">
  ...
  return (
    <div className={`w-full h-full bg-black text-white ${className}`}>
      <div className="w-full h-full overflow-y-auto">
        ...
        <div className="w-full px-6 py-8 border-b border-zinc-800/50 bg-black/50 backdrop-blur-sm sticky top-0 z-10">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="w-full">
                {filteredPurchases.map((purchase, index) => (
                  <motion.div
                    ...
                    className="w-full"
                  >
                    <div className="bg-zinc-900/20 border-0 border-b border-zinc-800/30 hover:bg-zinc-900/40 transition-all duration-300">
