...
export function LoginForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div className={cn("min-h-screen flex relative overflow-hidden bg-black", className)} {...props}>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 relative z-10">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl md:text-4xl font-semibold text-white">Log In</h1>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 pr-10 bg-gray-900/50 border-gray-700 text-white placeholder-gray-500 focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                  required
                />
                <Button
                  type="button"
