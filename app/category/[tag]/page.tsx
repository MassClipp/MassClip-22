...
export default function CategoryPage() {
  ...
  useEffect(() => {
    if (tagSlug.toLowerCase() === "browse-all") {
  ...
  useEffect(() => {
    async function fetchVideos() {
      if (redirectInProgress || tagSlug.toLowerCase() === "browse-all") return
    ...
    fetchVideos()
  }, [tagSlug, page, redirectInProgress])
  ...
  if (tagSlug.toLowerCase() === "browse-all" || redirectInProgress) {
    return (
