    ...
    try {
      ...
      const state = Buffer.from(
        JSON.stringify({
          ...
          // Add a flag to indicate this is for OAuth connection, not direct account creation
          flow: "oauth_connect",
        }),
      ).toString("base64")
      ...
      console.log(`✅ [OAuth] Generated OAuth URL for user ${userId} - Flow: OAuth Connect`)
