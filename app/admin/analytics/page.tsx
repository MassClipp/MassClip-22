      ...
      <Tabs defaultValue="revenue" className="space-y-6">
        ...
        <TabsContent value="retention" className="space-y-6">
          {stats.userRetention ? (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.userRetention.dailyActiveUsers.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.userRetention.weeklyActiveUsers.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.userRetention.monthlyActiveUsers.toLocaleString()}</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{stats.userRetention.retentionRate.toFixed(1)}%</div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {(
                            (stats.userRetention.dailyActiveUsers / stats.userRetention.monthlyActiveUsers) *
                            100
                          ).toFixed(1)}
                          %
                        </span>
                      ...
                      <div className="w-full bg-muted rounded-full h-2">
                        <div
                          className="bg-blue-500 h-2 rounded-full"
                          style={{
                            width: `${(stats.userRetention.dailyActiveUsers / stats.userRetention.monthlyActiveUsers) * 100}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-muted-foreground mt-1">Higher is better - indicates sticky product</p>
                    </div>
                    ...
                    <div>
                      <div className="flex justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {(
                            (stats.userRetention.weeklyActiveUsers / stats.userRetention.monthlyActiveUsers) *
                            100
                          ).toFixed(1)}
                          %
                        </span>
                      ...
                      <div className="w-full bg-muted rounded-full h-2">
                        <div
                          className="bg-green-500 h-2 rounded-full"
                          style={{
                            width: `${(stats.userRetention.weeklyActiveUsers / stats.userRetention.monthlyActiveUsers) * 100}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-muted-foreground mt-1">Measures weekly engagement consistency</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {stats.contentEngagement && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>How users consume content</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                        ...
                        <p className="text-2xl font-bold">{stats.contentEngagement.totalViews.toLocaleString()}</p>
                      </div>
                      <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                        ...
                        <p className="text-2xl font-bold">{stats.contentEngagement.avgWatchTime.toFixed(1)}m</p>
                      </div>
                      <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-2xl font-bold">{stats.contentEngagement.completionRate.toFixed(1)}%</p>
                      </div>
                      <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
                        ...
                        <p className="text-2xl font-bold">{stats.contentEngagement.shareRate.toFixed(1)}%</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-center text-muted-foreground">Retention data not available for this time range</p>
              </CardContent>
            </Card>
          )}
        </TabsContent>
        ...
        <TabsContent value="insights" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <p className="text-2xl font-bold mt-2">
                      ${stats.revenueBreakdown.creatorEarnings.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {((stats.revenueBreakdown.creatorEarnings / stats.totalRevenue) * 100).toFixed(1)}% of total
                    </p>
                  </div>
                  <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                    <span className="text-sm font-medium">Platform Fees</span>
                    <p className="text-2xl font-bold mt-2">
                      ${stats.revenueBreakdown.platformFees.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {((stats.revenueBreakdown.platformFees / stats.totalRevenue) * 100).toFixed(1)}% of total
                    </p>
                  </div>
                  <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200 dark:border-purple-800">
                    ...
                    <p className="text-2xl font-bold mt-2">
                      $
                      {stats.revenueBreakdown.avgTransactionSize.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                      })}
                    </p>
                  ...
                  <div className="p-4 bg-orange-50 dark:bg-orange-950 rounded-lg border border-orange-200 dark:border-orange-800">
                    ...
                    <p className="text-2xl font-bold mt-2">
                      $
                      {stats.revenueBreakdown.largestTransaction.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                      })}
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">Single purchase</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {stats.geographicData && stats.geographicData.length > 0 && (
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {stats.geographicData.slice(0, 10).map((country, index) => (
                    <div key={country.country} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-green-600">
                          ${country.revenue.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {((country.revenue / stats.totalRevenue) * 100).toFixed(1)}% of revenue
                        </p>
                      </div>
                    </div>
                  ))}
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                    ...
                    <p className="text-2xl font-bold mt-2">{stats.deviceBreakdown.mobile.toLocaleString()}</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {((stats.deviceBreakdown.mobile / stats.totalUsers) * 100).toFixed(1)}% of users
                    </p>
                  </div>
                  <div className="p-4 bg-purple-50 dark:bg-purple-950 rounded-lg">
                    <span className="text-sm font-medium">Desktop</span>
                    <p className="text-2xl font-bold mt-2">{stats.deviceBreakdown.desktop.toLocaleString()}</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {((stats.deviceBreakdown.desktop / stats.totalUsers) * 100).toFixed(1)}% of users
                    </p>
                  </div>
                  <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg">
                    <span className="text-sm font-medium">Tablet</span>
                    <p className="text-2xl font-bold mt-2">{stats.deviceBreakdown.tablet.toLocaleString()}</p>
                    <p className="text-xs text-muted-foreground mt-1">
                      {((stats.deviceBreakdown.tablet / stats.totalUsers) * 100).toFixed(1)}% of users
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  <ResponsiveContainer width="100%" height={250}>
                    <PieChart>
                      <Pie
                        data={[
                          { name: "Mobile", value: stats.deviceBreakdown.mobile },
                          { name: "Desktop", value: stats.deviceBreakdown.desktop },
                          { name: "Tablet", value: stats.deviceBreakdown.tablet },
                        ]}
                        cx="50%"
                        cy="50%"
                        labelLine={false}
