...
export default function SignupPage() {
  ...
  const checkUsernameAvailability = async (username: string) => {
    ...
    try {
      ...
      const isAvailable = !userSnapshot.exists() && !usernameSnapshot.exists()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await signUp(email, password, username, finalDisplayName)
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      const result = await signInWithGoogle(username, finalDisplayName)
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <Input
              ...
              className="bg-gray-900/80 border-gray-800 text-white placeholder:text-gray-500 focus:border-red-500 focus:ring-red-500"
            />
            <p className="text-xs text-gray-400">This will be shown on your public profile (optional)</p>
          </motion.div>
