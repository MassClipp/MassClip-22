  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 pt-24 pb-16 max-w-5xl">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">Simple Upload</h1>
          <p className="text-zinc-400 mb-8 md:mb-12">Upload your content without category selection</p>
        </div>
