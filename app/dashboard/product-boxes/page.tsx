  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Product Boxes</h1>
        ...
        <div className="flex gap-3">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="bg-zinc-900 border-zinc-800 max-w-2xl">
              <DialogHeader>
                <DialogTitle>Create Product Box</DialogTitle>
                <DialogDescription>
              ...
              <form onSubmit={handleCreateProductBox} className="space-y-6">
                ...
                <div>
                  <Label htmlFor="title">Product Box Title</Label>
                  <Input
                    id="title"
      ...
      {productBoxes.length === 0 ? (
        <Card className="bg-zinc-900/60 border-zinc-800/50 backdrop-blur-sm">
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="text-xl font-medium text-white mb-2">No Product Boxes Yet</h3>
            <p className="text-zinc-400 text-center mb-6 max-w-md">
              Create your first product box to organize your premium content into packages that visitors can purchase.
            </p>
            <Button
              ...
              <Card className="bg-zinc-900/60 border-zinc-800/50 backdrop-blur-sm hover:border-zinc-700/50 transition-all duration-300">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-zinc-400">Content ({productBox.contentItems?.length || 0})</span>
                      ...
                      {(productBox.contentItems || []).length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          {(productBox.contentItems || []).slice(0, 3).map((uploadId, index) => (
                            <div
                              key={uploadId}
                            ...
                            >
                              ...
                              <button
                                onClick={() => handleRemoveContent(productBox, uploadId)}
                          ...
                          {(productBox.contentItems || []).length > 3 && (
                            <div className="bg-zinc-800 rounded px-2 py-1 text-xs text-zinc-400">
                              +{(productBox.contentItems || []).length - 3} more
                            </div>
                          )}
                        </div>
                      )}
